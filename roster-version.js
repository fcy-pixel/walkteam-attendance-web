...
export const ROSTER_20260924_FROM = "2026-09-24";
...
export function rosterCollection(team, date) {
  ...
  if (date === undefined || date >= ROSTER_20260924_FROM) return `students_${team}_20260924`;
  if (date >= ROSTER_TRANSFER_FROM) return `students_${team}_20260923`;
